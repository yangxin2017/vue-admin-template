...
.cms-main-head{
    background:url('../../../assets/cms/header/bghead.png') no-repeat center center;
...
.cms-fl{
    ...
    .cms-search{
        ...
        width: 255px;height:34px;margin:11px 0 0 5px;
        input{
    ...
    &.mid{
        text-align: center;padding:34px 0 0 0;letter-spacing:3px;
    }
